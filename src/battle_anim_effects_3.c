    ...
    if (GetBattlerSide(gBattleAnimAttacker) != B_SIDE_PLAYER)
    {
        ...
        if (gBattleSpritesDataPtr->battlerData[gBattleAnimTarget].transformSpecies == SPECIES_NONE)
        {
            if (GetBattlerSide(gBattleAnimTarget) == B_SIDE_PLAYER)
            {
                ...
                {
                    personality = GetMonData(&gPlayerParty[gBattlerPartyIndexes[gBattleAnimTarget]], MON_DATA_FORME, NULL);
                }
            }
            else
            {
                ...
                if(species == SPECIES_DEOXYS)
                {
                    personality = GetMonData(&gEnemyParty[gBattlerPartyIndexes[gBattleAnimTarget]], MON_DATA_FORME, NULL);
                }
            } 
        }
        else
    ...
    case 1:
        {
            ...
            if (GetBattlerSide(gBattleAnimAttacker) == B_SIDE_PLAYER)
            {
                ...
                if (gBattleSpritesDataPtr->battlerData[gBattleAnimAttacker].transformSpecies == SPECIES_NONE)
                {
                    ...
                    if(species == SPECIES_DEOXYS)
                    {
                        personality = GetMonData(&gPlayerParty[gBattlerPartyIndexes[gBattleAnimAttacker]], MON_DATA_FORME, NULL);
                    }
                }
                else
            ...
            else
            {
                ...
                if (gBattleSpritesDataPtr->battlerData[gBattleAnimAttacker].transformSpecies == SPECIES_NONE)
                {
                    ...
                    if(species == SPECIES_DEOXYS)
                    {
                        personality = GetMonData(&gEnemyParty[gBattlerPartyIndexes[gBattleAnimAttacker]], MON_DATA_FORME, NULL);
                    }
                }
                else
                    species = gBattleSpritesDataPtr->battlerData[gBattleAnimAttacker].transformSpecies;
